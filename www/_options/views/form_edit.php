<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="description" class="form-control" id="description" placeholder="description" value="<?php echo $_options['description']; ?>" >
        </div>	
    </div>
    <?php # /description ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="data" class="form-control" id="data" placeholder="data - textarea" ><?php echo $_options['data']; ?></textarea>
        </div>	
    </div>
    <?php # /data ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="group" class="form-control" id="group" placeholder="group" value="<?php echo $_options['group']; ?>" >
        </div>	
    </div>
    <?php # /group ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $_options['order_by']; ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
