<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="title" class="form-control" id="title" placeholder="title" value="<?php echo $tasks->getTitle(); ?>" >
        </div>	
    </div>
    <?php # /title ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="description" class="form-control" id="description" placeholder="description - textarea" ><?php echo $tasks->getDescription(); ?></textarea>    <script>
                ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="doc_id" class="form-control" id="doc_id" placeholder="doc_id" value="<?php echo $tasks->getDoc_id(); ?>" >
        </div>	
    </div>
    <?php # /doc_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_registre" class="form-control" id="date_registre" placeholder="date_registre" value="<?php echo $tasks->getDate_registre(); ?>" >
        </div>	
    </div>
    <?php # /date_registre ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_update" class="form-control" id="date_update" placeholder="date_update" value="<?php echo $tasks->getDate_update(); ?>" >
        </div>	
    </div>
    <?php # /date_update ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="color" class="form-control" id="color" placeholder="color" value="<?php echo $tasks->getColor(); ?>" >
        </div>	
    </div>
    <?php # /color ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $tasks->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
