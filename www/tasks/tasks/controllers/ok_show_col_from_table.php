...
if (!$error) {
    ...
    _options_push("config_tasks_show_col_from_table", $data, 'tasks');
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=tasks&a=ok_show_col_from_table&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
