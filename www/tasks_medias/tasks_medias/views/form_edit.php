<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="type" class="form-control" id="type" placeholder="type" value="<?php echo $tasks_medias->getType(); ?>" >
        </div>	
    </div>
    <?php # /type ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="url" class="form-control" id="url" placeholder="url - textarea" ><?php echo $tasks_medias->getUrl(); ?></textarea>    <script>
                ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="description" class="form-control" id="description" placeholder="description - textarea" ><?php echo $tasks_medias->getDescription(); ?></textarea>    <script>
                ClassicEditor
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" step="any" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $tasks_medias->getOrder_by(); ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
