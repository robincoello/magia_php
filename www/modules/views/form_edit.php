<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="label" class="form-control" id="label" placeholder="label" value="<?php echo $modules['label']; ?>" >
        </div>	
    </div>
    <?php # /label ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="module" class="form-control" id="module" placeholder="module" value="<?php echo $modules['module']; ?>" >
        </div>	
    </div>
    <?php # /module ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="description" class="form-control" id="description" placeholder="description - textarea" ><?php echo $modules['description']; ?></textarea>
        </div>	
    </div>
    <?php # /description ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $modules['order_by']; ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
