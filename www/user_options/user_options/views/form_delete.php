<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="user_id" class="form-control" id="user_id" placeholder="user_id" value="<?php echo $user_options->getUser_id(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /user_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="option" class="form-control" id="option" placeholder="option" value="<?php echo $user_options->getOption(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /option ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="data" class="form-control" id="data" placeholder="data - textarea"  disabled="" ><?php echo $user_options->getData(); ?></textarea>
        </div>	
    </div>
    <?php # /data ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $user_options->getOrder_by(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /order_by ?>
