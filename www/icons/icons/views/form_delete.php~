<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="provider" class="form-control" id="provider" placeholder="provider" value="<?php echo $icons->getProvider(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /provider ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="icon" class="form-control" id="icon" placeholder="icon" value="<?php echo $icons->getIcon(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /icon ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $icons->getOrder_by(); ?>"  disabled="" >
        </div>	
    </div>
    <?php # /order_by ?>
