...
<form class="form-inline" method="post" action="index.php">
    ...
    <input type="hidden" name="option" value="icons_pagination_items_limit">                                                         
    <input type="hidden" name="redi[redi]" value="5">                                                          
    <input type="hidden" name="redi[c]" value="icons">                                                          
    ...
    <div class="form-group">
        ...
        <div class="input-group">                    
            <input 
                ...
                name="data" 
                placeholder="" 
                value="<?php echo user_options("icons_pagination_items_limit", $u_id); ?>"> 
