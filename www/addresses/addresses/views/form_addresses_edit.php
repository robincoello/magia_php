<form class="form-horizontal" action="index.php" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">    
            <input type="text"  name="number" class="form-control" id="number" placeholder="<?php _t("Number"); ?>" value="<?php echo $address['number']; ?>" >
        </div>
        <div class="col-sm-6">    
            <input type="text"  name="address" class="form-control" id="address" placeholder="<?php _t("Address"); ?>" value="<?php echo $address['address']; ?>" >
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">    
            <input type="text"  name="postcode" class="form-control" id="postcode" placeholder="<?php _t("Postal code"); ?>" value="<?php echo $address['postcode']; ?>" >
        </div>

        <div class="col-sm-3">    
            <input type="text"  name="barrio" class="form-control" id="barrio" placeholder="<?php _t("Municipality"); ?>" value="<?php echo $address['barrio']; ?>" >
        </div>

        <div class="col-sm-3">    
            <input type="text"  name="city" class="form-control" id="city" placeholder="<?php _t("City"); ?>" value="<?php echo $address['city']; ?>" >
        </div>
    </div>
