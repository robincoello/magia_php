<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="doc_id" class="form-control" id="doc_id" placeholder="doc_id" value="<?php echo $gallery['doc_id']; ?>" >
        </div>	
    </div>
    <?php # /doc_id ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="description" class="form-control" id="description" placeholder="description - textarea" ><?php echo $gallery['description']; ?></textarea>
        </div>	
    </div>
    <?php # /description ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="alt" class="form-control" id="alt" placeholder="alt - textarea" ><?php echo $gallery['alt']; ?></textarea>
        </div>	
    </div>
    <?php # /alt ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea name="url" class="form-control" id="url" placeholder="url - textarea" ><?php echo $gallery['url']; ?></textarea>
        </div>	
    </div>
    <?php # /url ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="date" name="date_registre" class="form-control" id="date_registre" placeholder="date_registre" value="<?php echo $gallery['date_registre']; ?>" >
        </div>	
    </div>
    <?php # /date_registre ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="code" class="form-control" id="code" placeholder="code" value="<?php echo $gallery['code']; ?>" >
        </div>	
    </div>
    <?php # /code ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $gallery['order_by']; ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
