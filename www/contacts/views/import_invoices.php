...
// https://api.jquery.com/prop/
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <?php
                $fp = fopen("tmp/syb/factura.csv", "r");
                ...
                while ($data = fgetcsv($fp, 999, ",", '"')) {
                    ...
                    print "";
                    echo"<tr>";
                    echo "<td>" . ($factura_id) . "</td>"; //id                        
                    echo "<td>" . ($presupuesto_id) . "</td>"; //id                        
                    echo "<td>" . ($id_notac) . "</td>"; //id                        
                    echo "<td>" . ($id_cliente) . "</td>"; //id                        
                    echo "<td>" . ($id_vendedor) . "</td>"; //id                        
                    echo "<td>" . ($fr) . "</td>"; //id                        
                    echo "<td>" . ($total) . "</td>"; //id                        
                    echo "<td>" . ($iva) . "</td>"; //id                        
                    echo "<td>" . ($anticipo) . "</td>"; //id                        
                    echo "<td>" . (00) . "</td>"; //id                        
                    echo "<td>" . ($comentarios) . "</td>"; //id                        
                    echo "<td>" . ($comentarios_p) . "</td>"; //id                        
                    echo "<td>" . ($r1) . "</td>"; //id                        
                    echo "<td>" . ($r2) . "</td>"; //id                        
                    echo "<td>" . ($r3) . "</td>"; //id                        
                    echo "<td>" . ($fc) . "</td>"; //id                        
