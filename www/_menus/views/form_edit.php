<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="controller" class="form-control" id="controller" placeholder="controller" value="<?php echo $_menus['controller']; ?>" >
        </div>	
    </div>
    <?php # /controller ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="target" class="form-control" id="target" placeholder="target" value="<?php echo $_menus['target']; ?>" >
        </div>	
    </div>
    <?php # /target ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="number" name="order_by" class="form-control" id="order_by" placeholder="order_by" value="<?php echo $_menus['order_by']; ?>" >
        </div>	
    </div>
    <?php # /order_by ?>
