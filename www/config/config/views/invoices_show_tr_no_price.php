...
<div class="row">
    ...
    <div class="col-lg-8">
        ...
        <h1><?php _t("Invoices show tr no price"); ?></h1>

        <p>
            <?php _t("On the page to edit the invoices, show the lines that have zero price"); ?>?
        </p>    



        <p>
            <?php if (_options_option("config_invoices_show_tr_no_price")) { ?>
            ...
            <form class="form-inline" method="post" action="index.php">
                ...
                <input type="hidden" name="a" value="ok_invoices_show_tr_no_price">            
