...
if (permissions_has_permission($u_rol, 'config', "read")) {
    ...
    <?php if (modules_field_module('status', 'hr')) { ?>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-heading"><?php _t("HR"); ?></div>
            <div class="panel-body">
                <p>
                    <?php _t("Module for human resources management"); ?>
                </p>
            </div>

            <!-- List group -->
            <ul class="list-group">
                <li class="list-group-item"><a href="index.php?c=config&a=hr_employee_worked_days">hr_employee_worked_days</a></li>
