...
<div class="row">
    ...
    <div class="col-lg-8">
        ...
        <h1><?php _t("Orders show tr no price"); ?></h1>

        <p>
            <?php _t("On the page edit, details the orders, show the lines that have zero price"); ?>?
        </p>    



        <p>
            <?php if (_options_option("config_orders_show_tr_no_price")) { ?>
            ...
            <form class="form-inline" method="post" action="index.php">
                ...
                <input type="hidden" name="a" value="ok_orders_show_tr_no_price">            
