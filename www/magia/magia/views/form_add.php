...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_db" class="form-control" id="m_db" placeholder="m_db" value="" >
        </div>	
    </div>
    <?php # /m_db ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_table" class="form-control" id="m_table" placeholder="m_table" value="" >
        </div>	
    </div>
    <?php # /m_table ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_field_name" class="form-control" id="m_field_name" placeholder="m_field_name" value="" >
        </div>	
    </div>
    <?php # /m_field_name ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_action" class="form-control" id="m_action" placeholder="m_action" value="" >
        </div>	
    </div>
    <?php # /m_action ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="m_type" class="form-control" id="m_type" placeholder="m_type" value="" >
        </div>	
    </div>
    <?php # /m_type ?>
