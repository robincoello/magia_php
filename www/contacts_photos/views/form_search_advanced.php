<form class="form-horizontal" action="index.php" method="get" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">                    
            <input type="text" name="photo" class="form-control"  id="photo" placeholder="photo" value="">
        </div>	
    </div>
    <?php # photo ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">                    
            <input type="text" name="principal" class="form-control"  id="principal" placeholder="principal" value="">
        </div>	
    </div>
    <?php # principal ?>
