...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <?php include view("updates", "form_search") ?>
                ...
                <?php if (permissions_has_permission($u_rol, "config", "update")) { ?>
                    <li>
                        <a 
                            ...
                            href="#collapse_form_updates_pagination_items_limit" 
                            aria-expanded="false" 
                            aria-controls="collapse_form_updates_pagination_items_limit">
            ...
            <div class="collapse navbar-collapse" id="updates_add">
                <?php if (permissions_has_permission($u_rol, "updates", "create")) { ?>     
                    ...
                    <button type="button" class="btn btn-primary navbar-btn navbar-right" data-toggle="modal" data-target="#updatesModal">
                        <span class="glyphicon glyphicon-plus-sign"></span>
                        <?php _t("New updates"); ?>
                    </button>

                    <div class="modal fade" id="updatesModal" tabindex="-1" role="dialog" aria-labelledby="updatesModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title" id="updates_addLabel">
                                        <?php _t("Add new updates"); ?>                
                                    </h4>
                                </div>
...
<div class="collapse" id="collapse_form_updates_pagination_items_limit">
    <div class="well">
        <?php
        $redi = 1;
        include view("updates", "form_pagination_items_limit");
        echo "<br>";
