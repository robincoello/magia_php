...
<form class="form-horizontal" action="index.php" method="post" >
    ...
    <input type="hidden" name="redi[a]" value="<?php echo ($form['redi']['a']) ?? ''; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text"   name="title" class="form-control" id="title" placeholder="<?php _t("Title"); ?>" value="" autofocus="" >
        </div>	
    </div>
    <?php # /title   ?>
